export async function onRequestGet(context) {
  ...
  try {
    ...
    const checkedColumns = ["id", "amount", "currency", "payment_status", "razorpay_order_id", "razorpay_payment_id", "form_data", "selected_options"];
    ...
    if (!res.ok) {
      return jsonResponse({ success: false, error: "Supabase connection failed.", details: text }, 500);
    }
    ...
    return jsonResponse({ success: false, error: "Test failed.", details: error.message }, 500);
  }
}
